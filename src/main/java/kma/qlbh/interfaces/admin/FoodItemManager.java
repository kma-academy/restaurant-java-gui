 ...
 */
public class FoodItemManager extends javax.swing.JPanel {
    ...
    public FoodItemManager() {
        ...
        model.addColumn("Tên đv");
        model.addColumn("Giá đv");
        ...
        try {
            ...
            for (FoodItem foodItem : foodItems) {
                model.addRow(new Object[]{
                    foodItem.getId(), foodItem.getName(), foodItem.getDescription(), foodItem.getUrlImage(),
                    foodItem.getUnitName(), foodItem.getUnitPrice(), foodItem.getIdCategory()
                });
            }
        } catch (Exception e) {
            e.printStackTrace();
